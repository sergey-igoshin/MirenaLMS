# Generated by Django 3.2.16 on 2022-11-11 12:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("updated", models.DateTimeField(auto_now=True, verbose_name="Edited")),
                ("deleted", models.BooleanField(default=False)),
                ("course", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="todoapp.courses")),
            ],
            options={
                "ordering": ("course", "num"),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("deleted", models.BooleanField(default=False)),
                ("course", models.ManyToManyField(to="todoapp.Courses")),
            ],
        ),
    ]
