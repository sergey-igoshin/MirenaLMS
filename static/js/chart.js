 ...
 */
    ...
    class Gt {
        constructor(t) {
            ...
            let i;
            var s, n, o;
            "object" === e ? i = qt(t) : "string" === e && (o = (s = t).length,
            "#" === s[0] && (4 === o || 5 === o ? n = {
                r: 255 & 17 * kt[s[1]],
                g: 255 & 17 * kt[s[2]],
                b: 255 & 17 * kt[s[3]],
    ...
    function Ze(t, e, i, o) {
        ...
        return null !== c && ((!w(r) || r === i || (c = Je(h, l, r, c, o),
    ...
    function ai(t, e="x") {
        ...
        !function(t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c)
                l = h,
                h = si(t, c + 1),
                l && h && (F(e[c], 0, ii) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                o = i[c + 1] / e[c],
    ...
    function xs(t, e, i) {
        ...
        return a.observe(n),
        function(t, e) {
            ps.size || window.addEventListener("resize", bs),
            ps.set(t, e)
        }(t, o),
        a
    }
    ...
    class Bs {
        ...
        updateIndex(t) {
            this.index !== t && zs(this._cachedMeta),
            this.index = t
        }
        linkScales() {
            const t = this.chart
        ...
        updateRangeFromParsed(t, e, i, s) {
            ...
            s && a && (s.values = a,
            o = As(s, n, this._cachedMeta.index)),
    ...
    function Ws(t, e) {
        ...
        if (r > 0) {
            ...
            for (Hs(e, c, d, i(n) ? 0 : l - n, l),
            t = 0,
            s = r - 1; t < s; t++)
                Hs(e, c, d, a[t], a[t + 1]);
            return Hs(e, c, d, h, i(n) ? e.length : h + n),
            c
        }
        return Hs(e, c, d),
        c
    ...
    class Ks extends Ns {
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Ws(this, this.ticks),
            this._labelSizes = null,
            this.afterAutoSkip()),
            ...
            for (l = 0; l < e; ++l) {
                ...
                i(u) || s(u)) {
                    if (s(u))
                        ...
                        c = u.length; h < c; ++h)
                            _ = u[h],
                            i(_) || s(_) || (b = De(n, p.data, p.gc, b, _),
                            x += m)
                } else
                    b = De(n, p.data, p.gc, b, u),
                    x = m;
                a.push(b),
                r.push(x),
                y = Math.max(b, y),
        ...
        _computeLabelItems(t) {
            ...
            _ = l.length; x < _; ++x) {
                ...
                O = "top" === o ? "near" === c || 0 !== m ? -C * D + D / 2 : "center" === c ? -T.highest.height / 2 - e * D + D : -T.highest.height + D / 2 : "near" === c || 0 !== m ? D / 2 : "center" === c ? T.highest.height / 2 - e * D : T.highest.height - C * D,
                u && (O *= -1),
    ...
    class wn {
        ...
        constructor(t, i) {
            ...
            this._dataChanges = [],
            yn[this.id] = this,
            r && l ? (bt.listen(this, "complete", bn),
    ...
    function En(t, e, i, s) {
        ...
        (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Rn(c, a, r, l)] = !0,
        n = h)),
        o[Rn(n, a, r, l)] = !0,
        t.borderSkipped = o
    }
    function Rn(t, e, i, s) {
        var n, o, a;
        return s ? (a = i,
        t = In(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = In(t, e, i),
        t
    }
    function In(t, e, i) {
    ...
    var fo = {
        ...
        beforeLayout(t, e, i) {
            if (!i.enabled)
                return;
            const {type: s, options: {elements: n}, data: {datasets: o}} = t.config;
            if (uo(o) || n && uo(n))
                return;
            const a = co(s);
            o.forEach(a)
    ...
    class Io extends Ns {
        ...
        _draw() {
            ...
            this.legendItems.forEach(((y,v)=>{
                ...
                f.line++,
                S = f.x = ut(n, this.left + c, this.right - i[f.line])) : v > 0 && P + _ > this.bottom && (S = f.x = S + e[f.line].width + c,
                f.line++,
                P = f.y = ut(n, this.top + x + c, this.bottom - e[f.line].height));
                if (function(t, e, i) {
                    ...
                    o.usePointStyle) {
                        ...
                        const o = e + Math.max((d - p) / 2, 0)
                          ...
                          , r = Mi(i.borderRadius);
                        s.beginPath(),
                        Object.values(r).some((t=>0 !== t)) ? We(s, {
                            x: a,
                            y: o,
                            w: g,
                            h: p,
    ...
    class ea extends Ns {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Go(this, i.titleAlign, i),
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Go(this, i.footerAlign, i),
    ...
    class ra extends Ks {
        ...
        buildTicks() {
            ...
            const n = function(t, e) {
                ...
                k = h - 1,
                S = (w - M) / k) : (k = (w - M) / S,
                k = F(k, Math.round(k), S / 1e3) ? Math.round(k) : Math.ceil(k));
                ...
                M < a && D++,
                F(Math.round((M + D * S) * v) / v, a, aa(a, y, t)) && D++) : M < a && D++); D < k; ++D)
                    s.push({
            ...
            return "ticks" === t.bounds && H(n, this, "value"),
            t.reverse ? (n.reverse(),
            this.start = this.max,
    ...
    class ga extends Ks {
        ...
        buildTicks() {
            ...
            return "ticks" === t.bounds && H(e, this, "value"),
            t.reverse ? (e.reverse(),
            this.start = this.max,
            this.end = this.min) : (this.start = this.min,
            this.end = this.max),
    ...
    function Ma(t, e, i, s) {
        const {ctx: n} = t;
        if (i)
            n.arc(t.xCenter, t.yCenter, e, 0, C);
        else {
    ...
    function Da(t, e) {
        ...
        null === l ? null : (a && (l = "week" !== a || !N(r) && !0 !== r ? s.startOf(l, a) : s.startOf(l, "isoWeek", r)),
        +l)
    }
    function Ca(t, e, i, s) {
        const n = Sa.length;
    ...
    class Ta extends Ks {
        ...
        _generate() {
            ...
            u++)
                Oa(c, d, g);
            return d !== i && "ticks" !== s.bounds && 1 !== u || Oa(c, d, g),
    ...
    return Sn.register(Vn, Ra, oo, sa),
    Sn.helpers = {
        ...Bi
    },
    Sn._adapters = Cn,
